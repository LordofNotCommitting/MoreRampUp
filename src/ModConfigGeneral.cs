...
namespace MoreRampUp
{
    public class ModConfigGeneral
    {
        ...
        public ModConfigGeneral(string ModName, string ConfigPath)
        {
            ...
            this.ModData.AddConfigValue("general", "RU_Stack_Per_Proc_Bool", false, "RU Duration Stack per Proc", "When you have Ramp Up, and you proc another ramp up. Duration Stacks.");
            ...
            this.ModData.AddConfigValue("general", "RU_Duration_Limit", RU_Duration_Limit_Array[0], RU_Duration_Limit_Array[1], RU_Duration_Limit_Array[2], "Max RU Duration Limit", "Maximum limit of Ramp up Stack. Use it to limit max Ramp Up stack with stacking duration.");
            this.ModData.AddConfigValue("general", "RU_Additional_Shot_Limit", RU_Additional_Shot_Limit_Array[0], RU_Additional_Shot_Limit_Array[1], RU_Additional_Shot_Limit_Array[2], "Max RU Fire Rate Limit", "Maximum limit of Ramp up's Fire Rate.");
